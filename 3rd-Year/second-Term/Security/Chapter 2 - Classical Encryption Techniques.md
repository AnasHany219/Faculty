...
- `Substitution`: Replaces plaintext with ciphertext based on a rule.
	- Caesar Cipher, Monoalphabetic Cipher, Playfair Cipher, Hill Cipher, Polyalphabetic Cipher, One-Time Cipher.  
- `Transposition`: Rearranges plaintext characters.
	- Rail fence Cipher, Row Transposition Cipher.
...
### Processing Methods:
- `Block`: Encrypts fixed-size blocks of plaintext independently. *64 or 128 bits*
...
### 02) Monoalphabetic Cipher: Reversed Alphabet 🔡🔄🔒
...
---
### 04) Polyalphabetic Cipher "$Vigenère Cipher$" 🔑 :
...
```
---
### 06) One-Time Pad Encryption $OTP$ : Unbreakable Security
